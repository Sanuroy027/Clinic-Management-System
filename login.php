...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="files/assets/css/header.css">
...
<div class="header">
       <a href="login.php" class="logo">We-Care Clinic</a>
  ...
  <section class="login-block" style="background-image: url(https://cdn.dribbble.com/users/43762/screenshots/3035290/media/67ed39fbd21493bd131540f8bb9615af.gif);">
        ...
        <div class="col-sm-12">
          <div class="auth-box card">
            <div class="text-center">
              <image class="profile-img" src="uploadImage/Logo/logo1/<?php echo $logo; ?>" style="width: 50%"></image>
            </div>
            <div class="card-block">

              <div class="row m-b-20">
                <div class="col-md-12">
                  <h5 class="text-center txt-primary">Sign In / Log In</h5>
                </div>
              </div>
              <form method="POST">
                ...
                <div class="row m-t-25 text-left">
                  <div class="col-12">
                    <div class="forgot-phone text-right f-right">
                      <a href="signup.php" class="text-right f-w-600"> Sign Up?</a>
                    </div>
                  </div>
                </div>
