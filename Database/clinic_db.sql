...
(1, 'admin', 'wecare@gmail.com', 'aa7f019c326413d5b8bcad4314228bcd33ef557f5d81c7cc977f7728156f4357', 'We Care', 'admin', 'Male', '2018-11-26', '7795112778', '<p>Kolkata,West Bengal, India</p>\r\n', '<p>admin panel</p>\r\n', 'profile.jpg', '2018-04-30', '2019-10-15', 1, '0000-00-00', 0);
...
CREATE TABLE `department` (
  `departmentid` int(10) NOT NULL,
  `departmentname` varchar(10000) NOT NULL,
...
(3, 'Physiotherapy','Physiotherapy helps to restore movement and function when someone is affected by injury, illness or disability', 'Active', 0);
...
(1, 'Polyclinic', 'contact@polyclinic.com', 'www.polyclinic.com', '#', '#1234, Mysore, Karnataka, India', 'â‚¹', 'right', '0', '0000-00-00', '5.0', 'new_logo.png');
