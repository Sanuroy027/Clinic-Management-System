...
if (isset($_POST['btnsubmit'])) {
  ...
  if ($qsql = mysqli_query($conn, $bsql)) {
    location:
    "patientreport.php?patientid=$_POST[patientid]&appointmentid=$_POST[appointmentid]";
  } else {
            ...
            <div class="card-header">
              <div class="col-sm-10">
                <?php if (isset($useroles)) {
                  if (in_array("create_user", $useroles)) { ?>
                          ...
                          <tbody>
                            ...
                            <form class="" action="" method="POST">
                              ...
                              <tr style="display:none;">
                                <th scope="col">
                                  <div align="right">Billing ID &nbsp; </div>
                                </th>
...
<td>&nbsp; $rs[bill_type]";
                          ...
                          <div class="ftr" style="width:100%; background:#2B66B1; padding:7px;">
                            <h4 style="color:#ffffff;" align="center"><strong> We-Care</strong></h4>
                          </div>

                        </div>

                        <div align="center">
                          <a href=""><input Class="btn btn-primary m-b-0" type="submit" name="print" id="print" value="Print" onclick="saveAsPdf()" /></a>
